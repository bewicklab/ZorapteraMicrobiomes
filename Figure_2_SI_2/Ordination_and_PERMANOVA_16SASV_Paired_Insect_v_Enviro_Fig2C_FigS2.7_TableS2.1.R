...
points(pcoa_euclidean[1:6,],  pch=1, col = "black")
...
points(pcoa_jaccard[1:6,],  pch=1, col = "black")
...
points(pcoa_bray[1:6,],  pch=1, col = "black")
...
points(pcoa_unifrac[1:6,],  pch=1, col = "black")
...
points(pcoa_wunifrac[1:6,],  pch=1, col = "black")
...
write.csv(x=permanova_stats,file='Paired16SPermanova.csv')
...
write.csv(x=dispersion_stats,file='Paired16SDispersion.csv')
